...
class Wp_widget_aklamatorPop extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct(
            'wp_widget_aklamatorPop', // Base ID
            'Aklamator PopUp Digital PR', // Name
            array( 'description' => __( 'Display Aklamator Widgets in Sidebar')) // Widget Description
        );

        $this->aklamator_url= aklamatorPopWidget::init()->aklamator_url;
        $this->widget_data= get_option('aklamatorPopupWidgets');
    ...
    function widget( $args, $instance ) {
        ...
        if ( ! empty( $instance['title'] ) ) {
            ...
            $title_html = isset( $supertitle_html) ? $supertitle_html.$title : $title;
        }
        ...
        if($instance['widget_id'] != '')
            echo aklamatorPopWidget::init()->show_widget(do_shortcode( $instance['widget_id'] )); ?>
        <?php
...
//        $this->widget_data = $widget->api_data;
        ...
        <?php else :?>
            ...
            <a href="<?php echo admin_url(); ?>admin.php?page=aklamator-popup">Click here to configure Aklamator plugin</a>
            <br>
            <br>
        <?php endif;
